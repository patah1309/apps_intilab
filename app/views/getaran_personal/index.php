    ...
    <div class="section wallet-card-section pt-1">
        <div class="wallet-card">
            ...
            <div class="wallet-footer">
                <div class="item">
                    <a href="<?= base_url;?>/getaranpersonal/add_data">
                ...
                <div class="item">
                    <a href="<?= base_url;?>/getaranpersonal/viewData">
...
<div class="btnBottom">
    <div class="btnTengah" onclick="location.href='getaranpersonal/add_data'"></a></div>
    <div class="btnMenu">
        <ul>
            <li style="--i:0.1s;"><a href="<?= base_url;?>/home"><i class="fa-solid fa-gauge"></i></a></li>
            <li style="--i:0.2s;"><a href="<?= base_url;?>/getaranpersonal"><i class="fa-solid fa-house"></i></a></li>
            <li></li>
            <li style="--i:0.2s;"><a href="<?= base_url;?>/getaranpersonal/viewData"><i class="fa-solid fa-file-lines"></i></a></li>
    ...
    $('#sync').on('click', function(){
        ...
        if(net == "Online"){
            if($('#tdata').html() == 0){
                ...
                $.ajax({
                    url: '/public/getaranpersonal/upload_data_to_server',
                    method: 'POST',
