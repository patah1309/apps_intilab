                ...
                <div class="card-body pb-1">
                    <div class="form-group basic">
                        <div class="input-wrapper">
                            ...
                            <input type="text" class="form-control" id="kode_qr" name="kode_qr" placeholder="Masukan kode Qr" required value="<?= $data['qr'] ?>">
                            <i class="clear-input">
                    ...
                    <div class="form-group basic">
                        <div class="input-wrapper">
                            ...
                            <input type="text" class="form-control" id="lokasi_pengujian" name="lokasi_pengujian" placeholder="Alamat Lokasi Pengujian" required>
                            <i class="clear-input">
                                <ion-icon name="close-circle" role="img" class="md hydrated" aria-label="close circle"></ion-icon>
                            </i>
                        </div>
