...
<script>
    $(document).ready(function(){
        ...
        }else $("#load-detail").html( '<div class="alert alert-warning mt-2" role="alert" style="color: #856404;background-color: #fff3cd;border-color: #ffeeba;"><i class="fa-solid fa-triangle-exclamation fa-beat"></i> Data Not Found.!</div>')
    })
</script>