            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-4 col-md-4">
                        <a style="color: green; font-size: 20px;" href="./detailemisi" id="id_qr" value="">Hasil Record (<span id="sum"></span>)</a>
                    </div>
                    <a class="btn-add" href="<?= base_url; ?>/addOrderemisi" style="color: #ffffff !important;"><i class="fa-solid fa-circle-plus fa-xs"></i></a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function(){
        ...
        scanner.addListener("scan", function(e) {
                ...
                var a = global_var("dpath"),
                    o = global_var("checkQr");
                let r = getCookie("token");
                $.ajax({
                    url: a + o,
                    type: "post",
                    data: {
                    ...
                    success: function(e) {
                        $("#sum").html(e.record),
                            ...
                            0 != e.record ?
                            (localStorage.setItem("record", e.record),
                                localStorage.setItem("id_qr", e.id_qr),
                                localStorage.setItem("kode_qr", t),
                                localStorage.setItem("bbm", e.bbm),
                                localStorage.setItem("kategori_3", e.kategori_3),
                                localStorage.setItem("no_sample", e.no_sample),
                                localStorage.setItem("client", e.client),
                                localStorage.setItem("plat", e.plat),
                                localStorage.setItem("no_mesin", e.no_mesin),
                                localStorage.setItem("merk", e.merk),
                                localStorage.setItem("transmisi", e.transmisi),
                                localStorage.setItem("tahun", e.tahun),
                                localStorage.setItem("cc", e.cc),
                                localStorage.setItem("km", e.km),
                                localStorage.setItem("bobot", e.bobot),
                                localStorage.setItem("kategori", e.kategori)) :
                            (localStorage.setItem("kode_qr", t), localStorage.setItem("record", e.record));
                    },
                    error: function(e) {
                        Swal.fire({
                            icon: "info",
