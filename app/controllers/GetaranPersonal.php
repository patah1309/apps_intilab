...
class GetaranPersonal extends Controller {
    ...
    public function index()
	{
		if($_SESSION['versi'] == $this->versi()){
			...
			$this->view('getaran_personal/index', $data);
    ...
    public function add_data(){
        ...
        $this->view('templates/header', $data);
        $this->view('templates/sidebar', $data);
        $this->view('getaran_personal/input', $data);
        $this->view('templates/footer');
    }

    public function getSample(){
        $no_sample = $_POST['no_sample'];
		$val = $this->model('GetaranPersonalModel')->GetData($no_sample);
		echo $val;
    }
}