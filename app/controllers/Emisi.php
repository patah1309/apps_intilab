...
class Emisi extends Controller {
    ...
    public function bensin($data) {
        ...
        if($data->jenis_kendaraan == 31) {
            $jenisKen = 'Bensin';
        }else if($data->jenis_kendaraan == 32) {
            $jenisKen = 'Solar';
        }
        $file = file_get_contents('file/master_regulasi.json');
        $datoff = json_decode($file, true);
        foreach($datoff as $k => $v){
            if($v['id'] == $data->regulasi && $v['id_kategori'] == 5){
                $value = $v['peraturan'];
            }
        }
    $template = '<div class="card-body"><div class="row"><div class="col-sm-4"><div class="card-body"><table><tr><th></th><th></th><th></th></tr><tr class="detail"><td class="data">Kode QR</td><td>:</td><td><span>'.$data->kode_qr.'</span></td></tr><tr class="detail"><td class="data">No Sample</td><td>:</td><td><span>'.$data->no_sample.'</span></td></tr><tr class="detail"><td class="data">Nama Pelanggan</td><td>:</td><td><span>'.$data->nama.'</span></td></tr><tr class="detail"><td class="data">Alamat Lokasi Pengujian</td><td>:</td><td><span>'.$data->lokasi_pengujian.'</span></td></tr><tr class="detail"><td class="data">Jenis Bahan Bakar Kendaraan</td><td>:</td><td><span>'.$jenisKen.'</span></td></tr><tr class="detail"><td class="data">No Polisi</td><td>:</td><td><span>'.$data->no_plat.'</span></td></tr><tr class="detail"><td class="data">Nomor Mesin</td><td>:</td><td><span>'.$data->no_mesin.'</span></td></tr><tr class="detail"><td class="data">Merk Kendaraan</td><td>:</td><td><span>'.$data->merk.'</span></td></tr><tr class="detail"><td class="data">Tranmission</td><td>:</td><td><span>'.$data->transmisi.'</span></td></tr><tr class="detail"><td class="data">Tahun Pembuatan</td><td>:</td><td><span>'.$data->tahun.'</span></td></tr><tr class="detail"><td class="data">Kategori Kendaraan</td><td>:</td><td><span>'.$data->kategori_kendaraan.'</span></td></tr><tr class="detail"><td class="data">KM Kendaraan</td><td>:</td><td><span>'.$data->km.'</span></td></tr><tr class="detail"><td class="data">Kapasitas CC</td><td>:</td><td><span>'.$data->cc.'</span></td></tr><tr class="detail"><td class="data">Bobot Kendaraan</td><td>:</td><td><span>'.$data->bobot_kendaraan.'</span></td></tr><tr class="detail"><td class="data">CO2 %</td><td>:</td><td><span>'.$co2.'</span></td></tr><tr class="detail"><td class="data">CO %</td><td>:</td><td><span>'.$co.'</span></td></tr><tr class="detail"><td class="data">HC %</td><td>:</td><td><span>'.$hc.'</span></td></tr><tr class="detail"><td class="data">O2 %</td><td>:</td><td><span>'.$o2.'</span></td></tr><tr class="detail"><td class="data">Lambda (λ)</td><td>:</td><td><span>'.$data->lamda.'</span></td></tr><tr class="detail"><td class="data">Regulasi</td><td>:</td><td><span>'.$value.'</span></td></tr><tr class="detail"><td class="data">Catatan Kondisi Sampling</td><td>:</td><td><span>'.$data->catatan.'</span></td></tr></table></div></div></div></div>';
        return $template;
	}
    ...
    $template = '<div class="card-body"><div class="row"><div class="col-sm-4"><div class="card-body"><table><tr><th></th><th></th><th></th></tr><tr class="detail"><td class="data">Kode QR</td><td>:</td><td><span>'.$data->kode_qr.'</span></td></tr><tr class="detail"><td class="data">No Sample</td><td>:</td><td><span>'.$data->no_sample.'</span></td></tr><tr class="detail"><td class="data">Nama Pelanggan</td><td>:</td><td><span>'.$data->nama.'</span></td></tr><tr class="detail"><td class="data">Alamat Lokasi Pengujian</td><td>:</td><td><span>'.$data->lokasi_pengujian.'</span></td></tr><tr class="detail"><td class="data">Jenis Bahan Bakar Kendaraan</td><td>:</td><td><span>'.$jenisKen.'</span></td></tr><tr class="detail"><td class="data">No Polisi</td><td>:</td><td><span>'.$data->no_plat.'</span></td></tr><tr class="detail"><td class="data">Nomor Mesin</td><td>:</td><td><span>'.$data->no_mesin.'</span></td></tr><tr class="detail"><td class="data">Merk Kendaraan</td><td>:</td><td><span>'.$data->merk.'</span></td></tr><tr class="detail"><td class="data">Tranmission</td><td>:</td><td><span>'.$data->transmisi.'</span></td></tr><tr class="detail"><td class="data">Tahun Pembuatan</td><td>:</td><td><span>'.$data->tahun.'</span></td></tr><tr class="detail"><td class="data">Kategori Kendaraan</td><td>:</td><td><span>'.$data->kategori_kendaraan.'</span></td></tr><tr class="detail"><td class="data">KM Kendaraan</td><td>:</td><td><span>'.$data->km.'</span></td></tr><tr class="detail"><td class="data">Kapasitas CC</td><td>:</td><td><span>'.$data->cc.'</span></td></tr><tr class="detail"><td class="data">Bobot Kendaraan</td><td>:</td><td><span>'.$data->bobot_kendaraan.'</span></td></tr><tr class="detail"><td class="data">Opasitas (%HSU)</td><td>:</td><td><span>'.$opasitas.'</span></td></tr><tr class="detail"><td class="data">Nilai K(m-1)</td><td>:</td><td><span>'.$nilai_k.'</span></td></tr><tr class="detail"><td class="data">Putaran Mesin (RPM)</td><td>:</td><td><span>'.$rpm.'</span></td></tr><tr class="detail"><td class="data">Temperature Oli</td><td>:</td><td><span>'.$oli.'</span></td></tr><tr class="detail"><td class="data">Regulasi</td><td>:</td><td><span>'.$value.'</span></td></tr><tr class="detail"><td class="data">Catatan Kondisi Sampling</td><td>:</td><td><span>'.$data->catatan.'</span></td></tr></table></div></div></div></div>';
        return $template;
	}
